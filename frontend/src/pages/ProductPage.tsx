...
import { usedProduct, useDeleteProduct } from "../hooks/useProducts";
...
const ProductPage = () => {
  ...
  const { data: product, isLoading, error } = usedProduct(id!);
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      <div className="flex items-center justify-bet">
        <Link to="/" className="btn btn-ghost bgn-sm gap-1">
      ...
      <div className="grid lg:grid-cols-2 gap-4">
        ...
        <div className="card bg-base-300">
          <div className="card-body">
            ...
            <div className="flex flex-wrap gap-4 text-sm text-base-comment/20 my-2">
